...
![fancyss](https://i.theojs.net/docs/image_1k10u2w.webp '打开“软件中心”——“科学上网”')
...
:::
![fancyss](https://i.theojs.net/docs/image_18vardl.webp '清空配置')
...
:::
![fancyss](https://i.theojs.net/docs/image_upeb6r.webp '订阅节点')

### 第 4 步 - 订阅节点配置「更新管理」

![fancyss](https://i.theojs.net/docs/image_2vj9pj.webp '更新管理')

### 第 5 步 - 配置「DNS 设定」

![fancyss](https://i.theojs.net/docs/image_18d55uv.webp 'DNS设定')

### 第 6 步 - 启动设置

![fancyss](https://i.theojs.net/docs/image_1fhyjy6.webp '启动设置')
...
:::
![fancyss](https://i.theojs.net/docs/image_1d6qvr3.webp '更新订阅')
