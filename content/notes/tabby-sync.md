...
![Tabby](https://i.theojs.net/docs/202404281755529.webp '安装插件')

## 新建 Github token

访问 **Github token** 页面 <Pill icon="oui:token-key" name="生成 Token" link="https://github.com/settings/tokens" />

![Tabby](https://i.theojs.net/docs/202404281757509.webp '新建 Github token')

![Tabby](https://i.theojs.net/docs/202404281758078.webp '勾选 gist 保存')

## 配置 cloud-settings-sync

![Tabby](https://i.theojs.net/docs/202404281801350.webp '配置 cloud-settings-sync')
