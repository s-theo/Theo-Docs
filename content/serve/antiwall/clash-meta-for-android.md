...
head:
  - - meta
    - property: og:image
      content: https://i.theojs.net/logo/clash-meta-for-android.webp
---
...
![Clash Meta for Android 导入订阅配置 =300x](https://i.theojs.net/docs/20260102135135983.webp)

点击右上角【➕】，选择 **从 URL 导入**：

![Clash Meta for Android 从URL导入 =300x](https://i.theojs.net/docs/20260102135152264.webp)

填写配置名称，将订阅链接粘贴到【URL】中。  
**自动更新建议设置为 ≥ 1400 分钟**，确认无误后点击右上角保存：

![Clash Meta for Android 保存订阅配置 =300x](https://i.theojs.net/docs/20260102135205837.webp)

### 第三步：启用配置并连接

选择刚导入的配置，点击左上角返回：

![Clash Meta for Android 选择导入的配置 =300x](https://i.theojs.net/docs/20260102135220682.webp)

点击【已停止 · 点此启动】，系统会弹出 VPN 连接请求，请务必点击【确定】：

![Clash Meta for Android 启动代理 =300x](https://i.theojs.net/docs/20260102135230676.webp)

首次使用必须允许 VPN 权限，否则软件无法正常工作：

![Clash Meta for Android 设置权限 =300x](https://i.theojs.net/docs/20260102135241318.webp)

### 节点与代理模式设置

点击【代理】可切换节点或代理模式：

![Clash Meta for Android 设置代理模式 =300x](https://i.theojs.net/docs/20260102135254903.webp)

![Clash Meta for Android 切换线路 =300x](https://i.theojs.net/docs/20260102135305203.webp)

![Clash Meta for Android 设置模式 =300x](https://i.theojs.net/docs/20260102135314327.webp)

![Clash Meta for Android 各代理模式区别 =300x](https://i.theojs.net/docs/20260102135322374.webp)
