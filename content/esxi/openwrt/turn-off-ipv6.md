...
![IPV6](https://i.theojs.net/docs/v6-1.nuexini '删除 WAN6')
...
![IPV6](https://i.theojs.net/docs/v6-2.nuexini '编辑 IPV6 设置')

### 高级设置

![IPV6](https://i.theojs.net/docs/v6-3.nuexini '把 **IPv6 分配长度** 选择 **已禁用**')

![IPV6](https://i.theojs.net/docs/v6-4.nuexini '取消勾选 - **使用内置的 IPv6 管理**')

![IPV6](https://i.theojs.net/docs/v6-5.nuexini '高级设置')
...
![IPV6](https://i.theojs.net/docs/v6-7.nuexini '保存并应用')
...
![IPV6](https://i.theojs.net/docs/v6-9.nuexini '防火墙设置')
...
![IPV6](https://i.theojs.net/docs/v6-11.webp 'DHCP/DNS 设置')

- 下图为原版 **OpenWrt > 网络 > DHCP/DNS > 高级设置**

![IPV6](https://i.theojs.net/docs/v6-12.nuexini 'DHCP/DNS 设置')
