...
![宝塔面板](https://i.theojs.net/docs/WX20240223-222305%402x.webp 'Nginx/Apache')
...
![宝塔面板](https://i.theojs.net/docs/WX20240223-222617%402x.webp 'Node.js版本管理器')

![宝塔面板](https://i.theojs.net/docs/WX20240223-222723%402x.webp '在Node.js版本管理器中安装Node版本版本')

:::tip
命令运行版本默认状态是：未设置，这里我们需要选择一下版本，否则后面安装vitepress无法使用命令行模式。
:::

![宝塔面板](https://i.theojs.net/docs/WX20240223-222850%402x.webp 'Node.js设置')
...
![宝塔面板](https://i.theojs.net/docs/WX20240223-223335%402x.webp '添加站点')

:::tip 注意
数据库选择 【不创建】，PHP版本选择【纯静态】
:::
![宝塔面板](https://i.theojs.net/docs/WX20240223-223817%402x.webp '添加站点配置')

:::tip 注意
user.ini文件无法被批量删除，就点击文件右侧的删除按钮进行删除
:::
![宝塔面板](https://i.theojs.net/docs/WX20240223-223941%402x.webp '删除网站目录下的默认文件')

![宝塔面板](https://i.theojs.net/docs/WX20240223-224110%402x.webp '申请SSL证书')
...
![宝塔面板](https://i.theojs.net/docs/WX20240223-224612%402x.webp '设置完成后回到 【网站】，打开网站设置')
