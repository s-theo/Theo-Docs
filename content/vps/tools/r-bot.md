...
![一键脚本部署开ARM机器](https://i.theojs.net/docs/202309032107312.webp '获取 VPS INFO')
...
![一键脚本部署开ARM机器](https://i.theojs.net/docs/20230903211053.webp '下载甲骨文 API 密钥')

3. 点击添加，会弹出 “配置文件预览” 的窗口，我们需要记录里面的：“配置文件预览”！

![一键脚本部署开ARM机器](https://i.theojs.net/docs/202309032112188.webp '配置文件预览')
...
![一键脚本部署开ARM机器](https://i.theojs.net/docs/202309032121395.webp '编辑`client_config`文件')

确认配置文件无误以后，我们在 VPS 执行：`bash sh_client_bot.sh `

![一键脚本部署开ARM机器](https://i.theojs.net/docs/202309032126839.webp '执行：`bash sh_client_bot.sh `')

## R 探长的小助理

消息栏输入 `/oracle` (oracle 云管理)，如下图所示：
![一键脚本部署开ARM机器](https://i.theojs.net/docs/202309032123801.webp 'R 探长的小助理')
